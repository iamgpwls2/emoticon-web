...
const canSubmit = computed(
  () => Boolean(trimmedName.value) && !duplicateError.value && !props.loading
)
    ...
    <Transition name="folder-modal">
      ...
      >
        <div
          ...
          @click.stop
        >
          <h2 id="folder-modal-title" class="folder-modal__title">
            새 폴더 만들기
          </h2>

          <label class="folder-modal__label" for="folder-modal-name">
            폴더 이름
          </label>
          <input
